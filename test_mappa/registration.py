...
try:
    ...
    # Fill input fields:
    def fill_registration(username, email, password):
        driver.find_element_by_xpath('//*[@id="app"]//fieldset[1]/input').send_keys("username")
        driver.find_element_by_xpath('//*[@id="app"]//fieldset[2]/input').send_keys("email")
        driver.find_element_by_xpath('//*[@id="app"]//fieldset[3]/input').send_keys("password")
